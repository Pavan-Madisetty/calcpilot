...
export default function Dashboard({ onSelectCalculator, searchQuery }: DashboardProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Grid of calculators - Full Width 3 columns */}
      <div className="space-y-4">
        <div>
          <h3 className="text-base font-extrabold text-slate-800 uppercase tracking-wider">
            {searchQuery ? 'Search Outcomes' : 'Available Calculator Utilities'}
          </h3>
          <p className="text-xs text-slate-500 mt-1">
            Select one of the calculators below to perform instant computations.
          </p>
        </div>
